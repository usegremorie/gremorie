...
const fixture = readFileSync(
  join(__dirname, '__fixtures__/primitives-basic.css'),
  'utf8',
);
...
describe('parsePrimitives — real KDS file', () => {
  ...
  const kdsPath = join(
    __dirname,
    '../../../../kds/src/styles/tokens/primitive/colors.css',
  );

  it.skipIf(!existsSync(kdsPath))(
    'extracts at least 10 color primitives from KDS primitives',
    () => {
