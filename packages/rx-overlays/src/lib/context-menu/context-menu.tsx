 ...
 * also be reachable through a button, DropdownMenu, or keyboard
 * shortcut elsewhere in the UI.
 *
 * Same shape as DropdownMenu (items, groups, separators, sub-menus,
 * checkbox / radio variants). Anchors to a region rather than a
 * trigger button - wrap the region in `<ContextMenuTrigger>`.
 */
