 ...
 * destructive confirmations, irreversible actions, account
 * deletion. Tier 2 and Tier 3 of the KDS confirmation stakes
 * model live here.
 *
 * Per ADR-012, this primitive ships under
 * `@kalvner/kds/overlays/alert-dialog` with `cn` imported by
 * relative path. `AlertDialogAction` and `AlertDialogCancel`
 * delegate styling to the `Button` primitive at `forms/Button`.
 */
