 ...
 *
 * On `md` and up, prefer Dialog (focused decision) or Sheet
 * (longer flow) - desktop ergonomics don't reward bottom sheets.
 * The recommended pattern for responsive overlays is conditional:
 * Drawer below `md`, Dialog or Sheet above.
 */
function Drawer({
  ...props
