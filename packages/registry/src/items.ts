...
export const ITEMS: ItemConfig[] = [
  ...
  },
  {
    ...
    title: 'Command (React)',
    description:
      'Command palette primitive built on cmdk - inline picker (Combobox pattern) for keyboard-first navigation. The Cmd+K dialog variant lands when rx-overlays ships Dialog.',
  ...
  },
  {
    ...
    description:
      'PromptInput family for AI chat surfaces - state machine, drag-drop, paste-to-attach, status-driven Submit. Includes ActionMenu (dropdown), ModelSelector (select), attachment HoverCard previews, Speech button (Web Speech API), and Command palette wrappers.',
    categories: ['ai', 'forms'],
