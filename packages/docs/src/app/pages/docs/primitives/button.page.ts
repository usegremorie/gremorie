      ...
      >
        <docs-section title="Preview — variants" anchor="preview-variants">
          <docs-preview [code]="variantsCode" lang="html">
            <div class="flex flex-wrap items-center gap-2">
              ...
              <ai-button variant="destructive" ariaLabel="Destructive"
                >Destructive</ai-button
              >
              <ai-button variant="outline" ariaLabel="Outline"
                >Outline</ai-button
              >
              <ai-button variant="secondary" ariaLabel="Secondary"
                >Secondary</ai-button
              >
        ...
        <docs-section title="Preview — sizes" anchor="preview-sizes">
          <docs-preview [code]="sizesCode" lang="html">
            <div class="flex flex-wrap items-end gap-2">
              ...
              <ai-button [disabled]="true" ariaLabel="Disabled"
                >Disabled</ai-button
              >
            </div>
          </docs-preview>
        ...
        <docs-section title="Accessibility" anchor="a11y">
          <docs-prose>
            <ul class="ml-5 list-disc space-y-1">
              <li>
                Native <code>&lt;button&gt;</code> under the hood — full
                keyboard support out of the box (Tab, Enter, Space).
              </li>
              <li>
                <code>ariaLabel</code> recommended for icon-only buttons (size
                <code>icon</code>) — required by AT for context.
              </li>
              <li>
                <code>pressed</code> input toggles <code>aria-pressed</code> for
                toggle-button semantics (null = not a toggle).
              </li>
              <li>
                Focus ring uses the <code>--ring</code> semantic token, with
                offset against <code>--background</code>.
              </li>
              <li>
                Touch targets: <code>default</code>/<code>icon</code> = 36px,
                <code>sm</code> = 32px, <code>lg</code> = 40px — meets WCAG 2.2
                SC 2.5.8.
              </li>
            </ul>
          </docs-prose>
        ...
        <docs-section title="Theming" anchor="theming">
          <docs-prose>
            ...
            <ul class="ml-5 list-disc space-y-1">
              <li>
                <strong>default</strong> — <code>--primary</code> /
                <code>--primary-foreground</code>
              </li>
              <li>
                <strong>destructive</strong> — <code>--destructive</code> /
                <code>--destructive-foreground</code>
              </li>
              <li>
                <strong>outline</strong> — <code>--input</code> (border) +
                <code>--background</code> + hover <code>--accent</code>
              </li>
              <li>
                <strong>secondary</strong> — <code>--secondary</code> /
                <code>--secondary-foreground</code>
              </li>
              <li>
                <strong>ghost</strong> — transparent + hover
                <code>--accent</code>
              </li>
              <li>
                <strong>link</strong> — <code>--primary</code> as text color
              </li>
            </ul>
          </docs-prose>
        </docs-section>
...
export class SearchBar {
  ...
  protected readonly inputs: readonly ApiRow[] = [
    ...
    },
    {
      ...
      default: "'default'",
      description: 'Size class. Use icon for icon-only buttons (square).',
    },
    {
      name: 'type',
      ...
      default: "'button'",
      description:
        'Native button type. Stays as button by default to avoid accidental form submissions.',
    },
    {
      name: 'disabled',
      type: 'boolean',
    ...
    },
    {
      ...
      default: 'null',
      description:
        'Toggle state. null means not a toggle (no aria-pressed emitted).',
    },
    {
      name: 'ariaLabel',
      type: 'string',
    ...
    },
    {
      ...
      type: 'string',
      default: "''",
      description: 'Native HTML title tooltip.',
    },
  ];
  ...
  protected readonly outputs: readonly ApiRow[] = [
    {
      ...
      type: 'MouseEvent',
      description:
        'Fires on click. Carries the native MouseEvent in case modifier keys matter.',
    },
  ];
  ...
  protected readonly variants: readonly ApiRow[] = [
    {
      name: 'default',
      type: 'variant',
      description: 'Primary CTA. Solid background using --primary.',
    },
    {
      name: 'destructive',
      type: 'variant',
      description: 'Dangerous actions (delete, remove). Uses --destructive.',
    },
    {
      name: 'outline',
      type: 'variant',
      description:
        'Bordered, transparent fill. Secondary actions where presence is needed but not bold.',
    },
    {
      name: 'secondary',
      type: 'variant',
      description: 'Soft alternative to default. Uses --secondary.',
    },
    {
      name: 'ghost',
      type: 'variant',
      description:
        'No background at rest, accent on hover. Use in toolbars or compact layouts.',
    },
    {
      name: 'link',
      type: 'variant',
      description:
        'Renders like an underlined link. Use for inline navigation actions.',
    },
  ];
  ...
  protected readonly sizes: readonly ApiRow[] = [
    {
      name: 'default',
      type: 'size',
      description: '36px high (h-9), text-sm. The standard for most buttons.',
    },
    {
      name: 'sm',
      type: 'size',
      description: '32px high (h-8), text-xs. Compact rows.',
    },
    {
      name: 'lg',
      type: 'size',
      description: '40px high (h-10). Heroes and primary CTAs.',
    },
    {
      name: 'icon',
      type: 'size',
      description: '36px square. Icon-only buttons. Pair with ariaLabel.',
    },
  ];
}
