      ...
      <div class="flex flex-col gap-12 pb-12">
        <section class="flex flex-col items-start gap-6 pt-8">
          ...
          <p class="max-w-prose text-base text-muted-foreground sm:text-lg">
            Gremorie NG is the Angular library of AI-native components that
            should exist but doesn't. Built on
            <a
              ...
              >spartan-ng</a
            >
            primitives, integrates cleanly with
            <a
        ...
        <section class="grid gap-4 sm:grid-cols-3">
          <div class="rounded-lg border border-border bg-card p-5">
            ...
            <p class="mt-1 text-sm text-muted-foreground">
              Full PromptInput family — container, textarea, toolbar,
              attachments, model select, and submit with 4 states.
            </p>
          </div>
          <div class="rounded-lg border border-border bg-card p-5">
            ...
            <p class="mt-1 text-sm text-muted-foreground">
              ...
              <code class="rounded bg-muted px-1.5 py-0.5 font-mono text-xs"
                >ready → submitted → streaming → error</code
              >
              state machine.
            </p>
          </div>
          <div class="rounded-lg border border-border bg-card p-5">
            ...
            <p class="mt-1 text-sm text-muted-foreground">
              Inputs accept signals from Hashbrown, Vercel AI SDK, NgRx, or
              plain
              <code class="rounded bg-muted px-1.5 py-0.5 font-mono text-xs"
                >fetch()</code
              >.
