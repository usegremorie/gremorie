...
@Component({
  ...
  template: `
    <div
      class="group relative overflow-hidden rounded-md border border-border bg-card"
    >
      @if (lang() || title()) {
        <div
          class="flex items-center justify-between border-b border-border bg-muted/50 px-3 py-1.5 text-xs font-mono text-muted-foreground"
        >
