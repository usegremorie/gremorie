 ...
 *
 * Prefer Accordion over Tabs when **siblings should remain visible**
 * - accordion preserves vertical context, tabs swap context entirely.
 * Don't nest more than 2 levels deep; depth past that becomes a
 * scavenger hunt.
 */
function Accordion({
  ...props
