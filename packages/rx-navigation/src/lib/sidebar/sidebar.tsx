 ...
 *
 * Wrap any subtree using the sidebar in a `<SidebarProvider>` -
 * including each Storybook story and each docs preview Card. Do
 * NOT mount a global provider in apps/docs because Fumadocs ships
 * its own sidebar and a second one would conflict.
 */
