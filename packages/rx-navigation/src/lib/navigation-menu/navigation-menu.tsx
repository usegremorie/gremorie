 ...
 * trigger.
 *
 * For app-internal nav (sidebar, settings) use Sidebar or Tabs;
 * for action menus inside a single page use DropdownMenu. Don't
 * nest interactive overlays (Dialog, Popover) inside a panel -
 * focus management gets fragile fast.
 */
