...
Dashboard charts on D3 - headless primitives plus styled presets (area, line,
bar, scatter, pie, radar, radial). The styled components are opinionated; the
headless layer is there when you need to break out.
