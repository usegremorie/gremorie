...
<Card>
  <CardHeader>
    ...
    <CardDescription>App shell minimal: Header + Content + Footer.</CardDescription>
  </CardHeader>
  <CardContent>
    <SidebarPreview />
  </CardContent>
...
<Card>
  <CardHeader>
    ...
    <CardDescription>Team switcher + grupos de itens + footer com settings.</CardDescription>
  </CardHeader>
  <CardContent>
    <SidebarSaaS />
  </CardContent>
