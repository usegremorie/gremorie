...
<div className="grid gap-4 md:grid-cols-2">
  <Card>
    <CardHeader>
      ...
      <CardDescription>Sublinhado discreto, ideal quando o card já tem fundo.</CardDescription>
    </CardHeader>
    <CardContent>
      <TabsLineVariant />
    </CardContent>
  ...
  <Card>
    <CardHeader>
      ...
      <CardDescription>Ícones reforçam a categoria — não substituem rótulo.</CardDescription>
    </CardHeader>
    <CardContent>
      <TabsWithIcons />
    </CardContent>
  ...
  <Card className="md:col-span-2">
    <CardHeader>
      ...
      <CardDescription>Colunas finas, lista de seções à esquerda.</CardDescription>
    </CardHeader>
    <CardContent>
      <TabsVertical />
    </CardContent>
...
<Card>
  <CardHeader>
    ...
    <CardDescription>Bloquear acesso, mas mantendo o item visível para informar.</CardDescription>
  </CardHeader>
  <CardContent>
    <TabsDisabled />
  </CardContent>
