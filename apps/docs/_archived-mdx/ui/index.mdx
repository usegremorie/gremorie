---
title: UI
description: Primitivos Gremorie organizados em 9 categorias funcionais.
---

A camada **UI** reúne os primitivos Gremorie, cada um adaptado pra consumir os tokens semânticos e documentado com props, variantes, estados e composições reais.
