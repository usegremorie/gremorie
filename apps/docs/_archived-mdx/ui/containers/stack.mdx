...
<div className="my-4 rounded-md border border-fd-border p-4">
  <Stack gap="md">
    <div className="rounded-md border border-fd-border bg-fd-card px-4 py-3 text-fd-foreground">
      First item
    </div>
    <div className="rounded-md border border-fd-border bg-fd-card px-4 py-3 text-fd-foreground">
      Second item
  ...
  <Stack gap="lg">
    {['none', 'xs', 'sm', 'md', 'lg', 'xl', '2xl'].map((g) => (
      <div key={g}>
        ...
        <Stack gap={g}>
          <div className="rounded-md border border-fd-border bg-fd-card px-4 py-2 text-fd-foreground">
            A
          </div>
          <div className="rounded-md border border-fd-border bg-fd-card px-4 py-2 text-fd-foreground">
            B
...
<div className="my-4 rounded-md border border-fd-border p-4">
  <Stack
    justify="between"
    gap="none"
    className="h-40 rounded-md bg-fd-muted/40 p-2"
  >
    <div className="rounded-md border border-fd-border bg-fd-card px-4 py-2 text-fd-foreground">
      A
    </div>
