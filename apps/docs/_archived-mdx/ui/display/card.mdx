...
<div className="grid gap-4 md:grid-cols-2">
  <Card>
    ...
    <CardContent>Corpo principal do card.</CardContent>
    <CardFooter className="text-sm text-muted-foreground">
  ...
  <Card>
    ...
    <CardContent>A action ocupa as duas linhas do header.</CardContent>
  </Card>
  <Card>
    ...
    <CardContent>Conteúdo isolado por linha.</CardContent>
  </Card>
  <Card>
    <CardContent>
