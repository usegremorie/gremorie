...
<div className="grid gap-4 md:grid-cols-2">
  ...
  <Card>
    <CardHeader>
      ...
      <CardDescription>aria-invalid no trigger + mensagem abaixo.</CardDescription>
    </CardHeader>
    <CardContent>
      <div className="grid gap-2">
        ...
        <span className="block text-sm text-destructive">Selecione um país.</span>
      </div>
    </CardContent>
  </Card>
</div>
...
<Card>
  <CardHeader>
    ...
    <CardDescription>Listas longas se beneficiam de SelectGroup + SelectLabel + SelectSeparator.</CardDescription>
  </CardHeader>
  <CardContent>
    <Select>
