...
<div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
  ...
  <Card>
    <CardHeader>
      ...
      <CardDescription>Ações irreversíveis — sempre confirme antes.</CardDescription>
    </CardHeader>
    <CardContent>
...
<div className="grid gap-4 md:grid-cols-2">
  ...
  <Card>
    <CardHeader>
      ...
      <CardDescription>Spinner + texto — desabilitado para evitar duplo envio.</CardDescription>
    </CardHeader>
    <CardContent>
      <Button disabled>
  ...
  <Card>
    <CardHeader>
      ...
      <CardDescription>Toolbar e ações de tabela. Inclua aria-label.</CardDescription>
    </CardHeader>
...
<div className="grid gap-4 md:grid-cols-2">
  <Card>
    <CardHeader>
      ...
      <CardDescription>Cancelar à esquerda, ação primária à direita — convenção ocidental.</CardDescription>
    </CardHeader>
  ...
  <Card>
    <CardHeader>
      ...
      <CardDescription>Saída segura à esquerda, destrutivo à direita.</CardDescription>
    </CardHeader>
    <CardContent className="flex justify-end gap-3">
      <Button variant="ghost">Cancelar</Button>
      <Button variant="destructive">
