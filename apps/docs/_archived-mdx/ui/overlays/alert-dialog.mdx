...
<Card>
  <CardHeader>
    ...
    <CardDescription>Tier 2 — destrutivo. Botão Action com variante destructive.</CardDescription>
  </CardHeader>
  <CardContent>
    <DeleteItemsAlertDialog />
  </CardContent>
...
<Card>
  <CardHeader>
    ...
    <CardDescription>O botão de confirmação só habilita quando o usuário digita o nome do recurso.</CardDescription>
  </CardHeader>
  <CardContent>
    <DeleteProjectAlertDialog />
  </CardContent>
