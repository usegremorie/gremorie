...
import { ConversationPreview, ConversationEmptyPreview, ConversationLongPreview } from "@/components/ai-chatbot-demos";
import {
  Card,
  CardContent,
  CardDescription,
...
<Card>
  <CardHeader>
    ...
    <CardDescription>Conversation com 4 bubbles user/assistant.</CardDescription>
  </CardHeader>
  <CardContent>
    <ConversationPreview />
  </CardContent>
