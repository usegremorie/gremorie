...
<Tab value="npm">
```bash
npx gremorie@latest add rx-progress
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx gremorie@latest add rx-progress
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx gremorie@latest add rx-progress
```
</Tab>
<Tab value="bun">
```bash
bunx --bun gremorie@latest add rx-progress
```
</Tab>
</Tabs>
...
```tsx
{steps.map((step) => (
  <Progress key={step.id} value={step.percent} />
))}
```
