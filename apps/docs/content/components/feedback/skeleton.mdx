...
<Tab value="npm">
```bash
npx gremorie@latest add rx-skeleton
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx gremorie@latest add rx-skeleton
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx gremorie@latest add rx-skeleton
```
</Tab>
<Tab value="bun">
```bash
bunx --bun gremorie@latest add rx-skeleton
```
</Tab>
</Tabs>
...
- [Alert](/components/feedback/alert) - reach for Alert when the surface needs to explain *why* the user is waiting.
