...
<Tab value="npm">
```bash
npx gremorie@latest add rx-model-selector
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx gremorie@latest add rx-model-selector
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx gremorie@latest add rx-model-selector
```
</Tab>
<Tab value="bun">
```bash
bunx --bun gremorie@latest add rx-model-selector
```
</Tab>
</Tabs>
