...
- [PromptInput](/components/ai/prompt-input) - the toolbar where `Context` typically lives
- [ModelSelector](/components/ai/model-selector) - pair with `Context` to expose model + usage in one row
