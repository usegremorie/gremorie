...
For per-node action bars, use [`Toolbar`](/components/ai/toolbar). For zoom and fit controls, use [`Controls`](/components/ai/controls). `Panel` covers the rest.
...
- [Canvas](/components/ai/canvas) - the surface that hosts panels
- [Controls](/components/ai/controls) - canvas-anchored zoom and fit controls
- [Toolbar](/components/ai/toolbar) - per-node selection-anchored action bar
