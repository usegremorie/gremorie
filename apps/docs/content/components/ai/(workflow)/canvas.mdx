...
Pair with [`Connection`](/components/ai/connection) for a Gremorie-themed connection preview.
...
- [Node](/components/ai/node) - card-shaped node used inside Canvas
- [Edge](/components/ai/edge) - themed edge component
- [Connection](/components/ai/connection) - in-progress connection line while dragging
- [Controls](/components/ai/controls) - zoom and fit controls docked to a corner
- [Panel](/components/ai/panel) - free-floating overlay anchored to a canvas corner
- [Toolbar](/components/ai/toolbar) - per-node floating action bar
