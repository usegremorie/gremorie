...
- [Canvas](/components/ai/canvas) - the surface that hosts `Controls`
- [Panel](/components/ai/panel) - free-floating overlay if you need a more flexible corner widget
- [Toolbar](/components/ai/toolbar) - per-node floating actions (different concern - selection-anchored, not canvas-anchored)
