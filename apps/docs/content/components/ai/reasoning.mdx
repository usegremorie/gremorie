...
- [Message](/components/ai/message) - the typical parent for `Reasoning`
- [Chain of Thought](/components/ai/chain-of-thought) - step-by-step reasoning when you have discrete actions to surface
- [Shimmer](/components/ai/shimmer) - the loading affordance used inside the default trigger
