...
`Task` is the granular unit of agent work. Where [Plan](/components/ai/plan) describes the whole multi-step plan and [Chain of Thought](/components/ai/chain-of-thought) shows step-by-step reasoning, `Task` represents a single named task with its specific actions and the files it touched.
...
- [Plan](/components/ai/plan) - the multi-task plan that hosts tasks
- [Chain of Thought](/components/ai/chain-of-thought) - per-step reasoning inside a task
- [Confirmation](/components/ai/confirmation) - approval gate before running a destructive task
