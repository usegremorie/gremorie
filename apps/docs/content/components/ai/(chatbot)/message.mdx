...
- [Conversation](/components/ai/conversation) - scroll-to-bottom container for a stream of messages
- [Reasoning](/components/ai/reasoning) - collapsible thinking block to embed inside a Message
- [Sources](/components/ai/sources) - cite the documents an assistant turn used
- [InlineCitation](/components/ai/inline-citation) - inline footnote-style citations inside `MessageResponse`
