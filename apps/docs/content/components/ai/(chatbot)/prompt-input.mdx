...
- [Message](/components/ai/message) - the assistant / user turn rendered above this composer
- [Conversation](/components/ai/conversation) - the scrollable surface that hosts both messages and this composer
- [Model Selector](/components/ai/model-selector) - alternative standalone model picker if you do not want it inline
- [Suggestion](/components/ai/suggestion) - pre-baked prompts users can click to seed the textarea
- [Open in Chat](/components/ai/open-in-chat) - hand the current query off to an external chat
