...
<Tab value="npm">
```bash
npx gremorie@latest add rx-edge
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx gremorie@latest add rx-edge
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx gremorie@latest add rx-edge
```
</Tab>
<Tab value="bun">
```bash
bunx --bun gremorie@latest add rx-edge
```
</Tab>
</Tabs>
...
```tsx
const edges = [
  { id: "draft-1", source: "a", target: "b", type: "temporary" },
];
```
