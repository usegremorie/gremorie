...
import { TaskCollapsedPreview, TaskExpandedPreview } from "@/components/preview/ai/chatbot";
...
<Tab value="npm">
```bash
npx gremorie@latest add rx-task
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx gremorie@latest add rx-task
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx gremorie@latest add rx-task
```
</Tab>
<Tab value="bun">
```bash
bunx --bun gremorie@latest add rx-task
```
</Tab>
</Tabs>
