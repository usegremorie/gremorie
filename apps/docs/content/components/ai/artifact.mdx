...
<Tab value="npm">
```bash
npx gremorie@latest add rx-artifact
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx gremorie@latest add rx-artifact
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx gremorie@latest add rx-artifact
```
</Tab>
<Tab value="bun">
```bash
bunx --bun gremorie@latest add rx-artifact
```
</Tab>
</Tabs>
...
<Artifact>
  <ArtifactHeader>
    ...
    <ArtifactActions>
      <ArtifactAction tooltip="Download" icon={DownloadIcon} onClick={download} />
      <ArtifactClose />
    </ArtifactActions>
  </ArtifactHeader>
  <ArtifactContent>
