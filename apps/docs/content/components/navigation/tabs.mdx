...
import { TabsPreview } from "@/components/preview/navigation/navigation";
import { Tabs as RxTabs, TabsList, TabsTrigger, TabsContent } from "@gremorie/rx-navigation";
...
<Tab value="npm">
```bash
npx gremorie@latest add rx-tabs
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx gremorie@latest add rx-tabs
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx gremorie@latest add rx-tabs
```
</Tab>
<Tab value="bun">
```bash
bunx --bun gremorie@latest add rx-tabs
```
</Tab>
</Tabs>
...
<div className="rounded-lg border p-6 not-prose">
  <RxTabs defaultValue="profile">
    ...
    <TabsContent value="profile" className="mt-4 text-sm text-muted-foreground">Profile fields...</TabsContent>
    <TabsContent value="billing" className="mt-4 text-sm text-muted-foreground">Billing details...</TabsContent>
    <TabsContent value="api" className="mt-4 text-sm text-muted-foreground">API keys list...</TabsContent>
  </RxTabs>
</div>
...
<div className="rounded-lg border p-6 not-prose">
  <RxTabs defaultValue="overview">
    ...
    <TabsContent value="overview" className="mt-4 text-sm text-muted-foreground">High-level summary.</TabsContent>
    <TabsContent value="usage" className="mt-4 text-sm text-muted-foreground">Code patterns.</TabsContent>
    <TabsContent value="api" className="mt-4 text-sm text-muted-foreground">Prop tables.</TabsContent>
  </RxTabs>
</div>
