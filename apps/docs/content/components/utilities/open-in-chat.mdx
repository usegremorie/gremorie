...
- [Conversation](/components/chatbot/conversation) - the surface where the conversation lives before it gets handed off
- [Message](/components/chatbot/message) - the turn that typically hosts this affordance
- [Suggestion](/components/chatbot/suggestion) - the inverse direction: suggested prompts to start a new conversation
