...
<Tab value="Angular">
```bash
npx gremorie@latest add ng-toggle-group
```
...
- [Toggle](/components/buttons/toggle) - the underlying single-button primitive
- [Button Group](/components/buttons/button-group) - visual cousin without coordinated state
- [Radio Group](/components/selection/radio-group) - label-led single-select for form values
