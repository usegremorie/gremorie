...
@Component({
  ...
  template: `
    <ng-scrollbar gremorie class="h-72 w-48 rounded-md border">
      <div class="p-4">
...
A edição Angular é uma diretiva de estilização `gremorie` aplicada ao elemento `<ng-scrollbar>` do ngx-scrollbar; `ScrollAreaImports` agrupa ambos.
