...
<Tab value="npm">
```bash
npx gremorie@latest add rx-aspect-ratio
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx gremorie@latest add rx-aspect-ratio
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx gremorie@latest add rx-aspect-ratio
```
</Tab>
<Tab value="bun">
```bash
bunx --bun gremorie@latest add rx-aspect-ratio
```
</Tab>
</Tabs>
...
<div className="rounded-lg border p-6 not-prose">
  <div className="max-w-md">
    <AspectRatio ratio={16 / 9} className="animate-pulse rounded-md bg-accent" />
  </div>
</div>
