...
<div className="rounded-lg border p-6 not-prose">
  <Stack gap="md" className="max-w-sm">
    <div className="rounded-md border p-3 text-sm">Profile</div>
    <div className="rounded-md border p-3 text-sm">Notifications</div>
    <div className="rounded-md border p-3 text-sm">Billing</div>
  </Stack>
</div>
