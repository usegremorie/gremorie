...
- [Reasoning](/components/chatbot/reasoning) - free-form chain-of-thought when you have no discrete steps
- [Task](/components/chatbot/task) - explicit task list with nested files / actions
- [Plan](/components/chatbot/plan) - higher-level execution plan with phases
- [Sources](/components/chatbot/sources) - render the citations referenced inside the steps
