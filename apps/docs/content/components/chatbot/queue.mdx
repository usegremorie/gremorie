...
- [PromptInput](/components/chatbot/prompt-input) - sits below the queue
- [Suggestion](/components/chatbot/suggestion) - quick-reply chips for the empty queue
- [Task](/components/chatbot/task) - per-task breakdown when an item expands into sub-steps
