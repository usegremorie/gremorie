...
- [Message](/components/chatbot/message) - atomic turn rendered inside `ConversationContent`
- [PromptInput](/components/chatbot/prompt-input) - input dock typically rendered below the conversation
- [Suggestion](/components/chatbot/suggestion) - quick-reply chips that often pair with the empty state
