...
<Tab value="Angular">
```bash
npx gremorie@latest add ng-shimmer
```
...
- [Reasoning](/components/chatbot/reasoning) - uses `Shimmer` internally while streaming
- [Plan](/components/chatbot/plan) - uses `Shimmer` on title and description while streaming
- [Suggestion](/components/chatbot/suggestion) - quick-replies that often pair with a shimmering label
