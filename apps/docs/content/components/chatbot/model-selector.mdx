...
- [PromptInput](/components/chatbot/prompt-input) - typical host of the model trigger
- [Context](/components/chatbot/context) - pair with the selector to show usage of the current model
- [OpenInChat](/components/utilities/open-in-chat) - kickoff variant that includes model pre-selection
