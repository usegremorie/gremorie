...
- [Tool](/components/chatbot/tool) - the tool-call surface this primitive guards
- [Plan](/components/chatbot/plan) - when the approval is for a multi-step plan rather than a single tool call
- [Message](/components/chatbot/message) - the conversation surface that hosts the confirmation
