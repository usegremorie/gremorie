...
- [Switch](/components/forms/switch) - immediate-effect toggle (vs form-submission selection)
- [Radio Group](/components/forms/radio-group) - single-select cousin
- [Label](/components/forms/label) - the canonical companion
- [Form](/components/forms/form) - wire Checkbox into react-hook-form
