...
- [Input](/components/forms/input) - the most common companion control
- [Form](/components/forms/form) - use `FormLabel` to skip manual `htmlFor` wiring
- [Checkbox](/components/forms/checkbox) - pair with Label for the "accept terms" pattern
- [Switch](/components/forms/switch) - same pattern as Checkbox
- [Radio Group](/components/forms/radio-group) - one Label per option
