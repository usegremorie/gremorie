...
- [Label](/components/forms/label) - the accessible label primitive
- [Input Group](/components/forms/input-group) - wrap Input with icons, buttons, or kbd hints
- [Textarea](/components/forms/textarea) - multi-line counterpart
- [Form](/components/forms/form) - wires Input to react-hook-form with ARIA helpers
- [Input OTP](/components/forms/input-otp) - segmented input for one-time codes
