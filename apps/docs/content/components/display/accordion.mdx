...
import { Accordion, AccordionItem, AccordionTrigger, AccordionContent } from "@gremorie/rx-display";
...
<Tab value="npm">
```bash
npx gremorie@latest add rx-accordion
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx gremorie@latest add rx-accordion
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx gremorie@latest add rx-accordion
```
</Tab>
<Tab value="bun">
```bash
bunx --bun gremorie@latest add rx-accordion
```
</Tab>
</Tabs>
...
<div className="rounded-lg border p-6 not-prose">
  <Accordion type="single" collapsible className="w-full">
    <AccordionItem value="q1">
      ...
      <AccordionContent>Yes. Built on Radix Accordion with full WAI-ARIA support.</AccordionContent>
    </AccordionItem>
    <AccordionItem value="q2">
      <AccordionTrigger>Is it animated?</AccordionTrigger>
      <AccordionContent>Yes, height-aware open and close animations. Honors prefers-reduced-motion.</AccordionContent>
    </AccordionItem>
    <AccordionItem value="q3">
      <AccordionTrigger>Is it themeable?</AccordionTrigger>
      <AccordionContent>Yes. All colors come from Gremorie design tokens.</AccordionContent>
    </AccordionItem>
  </Accordion>
</div>
...
<Accordion type="single" collapsible>
  ...
  <AccordionItem value="q2">
    <AccordionTrigger>Is it animated?</AccordionTrigger>
    <AccordionContent>Yes, height-aware open and close animations.</AccordionContent>
  </AccordionItem>
</Accordion>
```
...
<div className="rounded-lg border p-6 not-prose">
  <Accordion type="multiple" defaultValue={["release-1", "release-2"]} className="w-full">
    ...
    <AccordionItem value="release-3">
      ...
      <AccordionContent>Composed patterns: DataTable, FormBuilder.</AccordionContent>
    </AccordionItem>
  </Accordion>
</div>
