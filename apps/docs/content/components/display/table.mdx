...
import { Table, TableHeader, TableBody, TableFooter, TableRow, TableHead, TableCell, TableCaption } from "@gremorie/rx-display";
...
<Tab value="npm">
```bash
npx gremorie@latest add rx-table
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx gremorie@latest add rx-table
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx gremorie@latest add rx-table
```
</Tab>
<Tab value="bun">
```bash
bunx --bun gremorie@latest add rx-table
```
</Tab>
</Tabs>
