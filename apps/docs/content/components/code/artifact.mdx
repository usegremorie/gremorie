...
- [Code Block](/components/code/code-block) - the most common content inside an artifact
- [Web Preview](/components/code/web-preview) - live HTML preview inside an artifact
- [Image](/components/utilities/image) - base64 image surface for AI-generated images
- [Tool](/components/chatbot/tool) - similar collapsible chrome, but for tool calls rather than artifacts
