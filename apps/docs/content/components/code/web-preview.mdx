...
Pair with [`Artifact`](/components/code/artifact) when the preview is part of a generated asset, or use it standalone as a live preview tile in a workspace.
...
- [Artifact](/components/code/artifact) - card chrome that often hosts a `WebPreview`
- [Code Block](/components/code/code-block) - the source code that this preview renders
- [Open in Chat](/components/utilities/open-in-chat) - hand a generated page back to the chat for iteration
