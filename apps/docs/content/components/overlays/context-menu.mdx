...
<Tab value="Angular">
```bash
npx gremorie@latest add ng-context-menu
```
...
### Submenu, checkbox, and shortcuts

Right-click the region to open a menu that combines shortcuts, a nested `ContextMenuSub`, a checkbox item, and a destructive action.
