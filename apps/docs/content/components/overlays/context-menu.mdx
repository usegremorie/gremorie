...
<Tab value="npm">
```bash
npx gremorie@latest add rx-context-menu
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx gremorie@latest add rx-context-menu
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx gremorie@latest add rx-context-menu
```
</Tab>
<Tab value="bun">
```bash
bunx --bun gremorie@latest add rx-context-menu
```
</Tab>
</Tabs>
