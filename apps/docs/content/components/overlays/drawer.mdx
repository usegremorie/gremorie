...
<Tab value="npm">
```bash
npx gremorie@latest add rx-drawer
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx gremorie@latest add rx-drawer
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx gremorie@latest add rx-drawer
```
</Tab>
<Tab value="bun">
```bash
bunx --bun gremorie@latest add rx-drawer
```
</Tab>
</Tabs>
...
<Drawer snapPoints={[0.4, 1]} activeSnapPoint={snap} setActiveSnapPoint={setSnap}>
  ...
  <DrawerContent>
    {/* content scales between 40% and 100% */}
  </DrawerContent>
</Drawer>
```
