...
<Tab value="npm">
```bash
npx gremorie@latest add rx-popover
```
</Tab>
<Tab value="pnpm">
```bash
pnpm dlx gremorie@latest add rx-popover
```
</Tab>
<Tab value="yarn">
```bash
yarn dlx gremorie@latest add rx-popover
```
</Tab>
<Tab value="bun">
```bash
bunx --bun gremorie@latest add rx-popover
```
</Tab>
</Tabs>
...
<Popover>
  ...
  <PopoverContent>
    <PopoverHeader>
      ...
      <PopoverDescription>Tweak preferences for this session.</PopoverDescription>
    </PopoverHeader>
