...
- [Input](/components/text/input) - the canonical single-line text field
- [Form](/components/form) - wire OTP into react-hook-form for verification flows
- [Button](/components/buttons/button) - the typical "Verify" trigger underneath the OTP
