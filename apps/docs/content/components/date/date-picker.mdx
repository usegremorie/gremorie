...
<Tab value="Angular">
```bash
npx gremorie@latest add ng-date-picker
```
...
- **Calendar keyboard**: full grid navigation via arrow keys, `Home`, `End`, `PageUp`, `PageDown`. See [Calendar accessibility](/components/date/calendar#accessibility) for the full list.
...
- [Calendar](/components/date/calendar) - the underlying grid primitive
...
- [Form](/components/form) - wire DatePicker into react-hook-form
