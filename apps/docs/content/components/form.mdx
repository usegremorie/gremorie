...
- [Input](/components/text/input) - most common control inside `FormControl`
- [Select](/components/selection/select) - dropdown inside `FormControl`
- [Checkbox](/components/selection/checkbox) - boolean inside `FormControl`
- [Switch](/components/selection/switch) - boolean inside `FormControl`
- [Textarea](/components/text/textarea) - multi-line inside `FormControl`
- [Slider](/components/selection/slider) - numeric inside `FormControl`
- [Label](/components/text/label) - the underlying primitive `FormLabel` wraps
