...
| `max` | `number` | `100` | Top of the radial scale. Pinned so two charts are read against one ruler: with a derived scale a top score of 70 fills the plot exactly like a top score of 100. **Raise it for data above 100**, or the polygons draw outside the outer ring. |
