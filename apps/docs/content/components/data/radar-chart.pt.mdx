...
| `max` | `number` | `100` | Topo da escala radial. Fixo para que dois gráficos sejam lidos na mesma régua: com escala derivada, uma nota máxima de 70 preenche o gráfico igual a uma de 100. **Aumente para dados acima de 100**, ou os polígonos desenham fora do anel externo. |
