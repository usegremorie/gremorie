...
<Callout type="info">
  This artifact renders streaming. As Markdown tokens arrive, the
  document grows top-to-bottom. Headings, lists, and blockquotes pop
  into place as they parse, with no flash between states.
</Callout>
