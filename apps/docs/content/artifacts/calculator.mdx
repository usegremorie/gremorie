...
<Callout type="info">
  This artifact renders after the payload parses, then takes over its own state.
  The model seeds the initial values; the user drives everything that follows.
  Subsequent tool calls can re-seed.
</Callout>
