...
<Callout type="info">
  This is the flagship Gremorie composition. The same three primitives power the
  chat surface block planned in [Blocks](/blocks).
</Callout>
...
<Callout type="tip">
  See the full wiring in the planned [chat-surface block](/blocks#chat-surface)
  -- it bundles a streaming SDK, attachments, and tool-call rendering.
</Callout>
