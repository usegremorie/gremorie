...
```bash
npx gremorie@latest add rx-dashboard
```
...
```bash
pnpm dlx gremorie@latest add rx-dashboard
```
...
```bash
yarn dlx gremorie@latest add rx-dashboard
```
...
```bash
bunx --bun gremorie@latest add rx-dashboard
```
