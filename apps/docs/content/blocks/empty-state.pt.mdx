...
```bash
npx gremorie@latest add rx-empty-state
```
...
```bash
pnpm dlx gremorie@latest add rx-empty-state
```
...
```bash
yarn dlx gremorie@latest add rx-empty-state
```
...
```bash
bunx --bun gremorie@latest add rx-empty-state
```
