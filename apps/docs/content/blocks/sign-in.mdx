...
```bash
npx gremorie@latest add rx-sign-in
```
...
```bash
pnpm dlx gremorie@latest add rx-sign-in
```
...
```bash
yarn dlx gremorie@latest add rx-sign-in
```
...
```bash
bunx --bun gremorie@latest add rx-sign-in
```
