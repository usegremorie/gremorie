...
const KPIs = [
  ...
  { label: "Customers", value: "2,318", delta: "+4.1%", trend: "up", icon: Users },
  { label: "Orders", value: "1,204", delta: "+18.3%", trend: "up", icon: ShoppingCart },
  { label: "Refunds", value: "$1,420", delta: "-3.2%", trend: "down", icon: CreditCard },
] as const;
