...
```bash
npx gremorie@latest add rx-settings-form
```
...
```bash
pnpm dlx gremorie@latest add rx-settings-form
```
...
```bash
yarn dlx gremorie@latest add rx-settings-form
```
...
```bash
bunx --bun gremorie@latest add rx-settings-form
```
