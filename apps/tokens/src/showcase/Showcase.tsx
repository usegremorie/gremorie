...
function buildInlineStyle(graph: any, theme: string, mode: "light" | "dark", changes: Change[]): CSSProperties {
...
export function Showcase() {
  ...
  const style = buildInlineStyle(graph, selectedTheme, selectedMode, pendingChanges);
  return (
